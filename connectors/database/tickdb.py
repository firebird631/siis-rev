...
class TickStreamer(object):
    ...
    @todo To be continued if we want to simulate a complete broker from a connector.
    From original, buffer might not longer contains Tick but only double array to avoid
    useless instance of objects.
    """
