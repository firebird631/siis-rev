...
void IndMarginTrade::orderSignal(OrderSignal *signal)
{

}

void IndMarginTrade::positionSignal(PositionSignal *signal)
{
...
o3d::Bool IndMarginTrade::isPositionOrder(const o3d::String &positionId, const o3d::String &orderRefId) const
{
    return false;
}
...
void IndMarginTrade::save(Database *db, Market *market)
{
    // @todo
}
