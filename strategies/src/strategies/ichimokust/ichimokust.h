...
#ifndef SIIS_ICHIMOKUST_STRAT_H
#define SIIS_ICHIMOKUST_STRAT_H
...
class IchimokuStSigAnalyser;
class IchimokuStRangeAnalyser;
class IchimokuStConfAnalyser;

/**
 * @brief Strategy Ichimoku.
 * @author Frederic Scherma
 * @date 2024-07-15
 */
class SIIS_PLUGIN_API IchimokuSt : public Strategy
{
public:

    IchimokuSt(Handler *handler, const o3d::String &identifier);
    virtual ~IchimokuSt() override;
...
private:
    ...
    IchimokuStSigAnalyser *m_sigAnalyser;
    IchimokuStRangeAnalyser *m_rangeAnalyser;
    IchimokuStConfAnalyser *m_confAnalyser;
