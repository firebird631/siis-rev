/**
 * @brief SiiS strategy SuperTrend range-bar strategy signal analyser.
 * @copyright Copyright (C) 2023 SiiS
 * @author Frederic SCHERMA (frederic.scherma@gmail.com)
 * @date 2023-09-30
 */

#ifndef SIIS_SUPERTRENDRBSIGANALYSER_H
#define SIIS_SUPERTRENDRBSIGANALYSER_H
...
/**
 * @brief SiiS SuperTrend range-bar strategy signal trend analyser.
 * @author Frederic Scherma
 * @date 2023-09-04
 * Signal analyser
 * @note It is important that price method is HLC.
 */
class SIIS_API SuperTrendRbSigAnalyser : public RangeBarAnalyser
{
public:
...
#endif // SIIS_SUPERTRENDRBSIGANALYSER_H
