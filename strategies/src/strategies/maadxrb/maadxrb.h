...
#ifndef SIIS_MAADXRB_H
#define SIIS_MAADXRB_H
...
/**
 * @brief Strategy MAADX range-bar.
 * @author Frederic Scherma
 * @date 2023-04-24
 */
class SIIS_PLUGIN_API MaAdxRb : public Strategy
{
public:

    MaAdxRb (Handler *handler, const o3d::String &identifier);
    virtual ~MaAdxRb () override;
...
private:
    ...
    MaAdxRbProfileAnalyser *m_profileAnalyser;
    ...
    o3d::Bool checkTrend(o3d::Int32 direction, o3d::Int32 vpUp, o3d::Int32 vpDn) const;
};

} // namespace siis

#endif // SIIS_MAADXRB_H
