...
void MarginTrade::orderSignal(OrderSignal *signal)
{

}

void MarginTrade::positionSignal(PositionSignal *signal)
{
...
o3d::Bool MarginTrade::isPositionOrder(const o3d::String &positionId, const o3d::String &orderRefId) const
{
    return false;
}
