...
void AssetTrade::orderSignal(OrderSignal *signal)
{

}

void AssetTrade::positionSignal(PositionSignal *signal)
{
...
o3d::Bool AssetTrade::isPositionOrder(const o3d::String &positionId, const o3d::String &orderRefId) const
{
    return false;
}
