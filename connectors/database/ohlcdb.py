...
class OhlcStorage(object):
    ...
    def async_query(self, receiver, timeframe, from_date, to_date, limit):
        self._mutex.acquire()
        self._queries.append((receiver, timeframe, from_date, to_date, limit))
        self._mutex.release()
    ...
    def process_async_queries(self):
        ...
        for query in queries:
            try:
                ...
                receiver.on_ohlc_array(self._market_id, query[1], ohlcs)
