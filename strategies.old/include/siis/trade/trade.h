...
public:
     ...
     */
    virtual void orderSignal(OrderSignal *signal) = 0;

    /**
     * @brief positionSignal Update the trade information according to the received position signal.
     */
    virtual void positionSignal(PositionSignal *signal) = 0;
    ...
    /**
     * @brief isPositionOrder Returns true if the id of the position of the reference order is related to one
     * of the position of this trade.
     * @param positionId Position identifier.
     * @param orderRefId Order reference identifier.
     */
    virtual o3d::Bool isPositionOrder(const o3d::String &positionId, const o3d::String &orderRefId) const = 0;
